  ...
  if(g_popup != null){
    ...
    if(includes_code){
      ...
      let infoopts = {
        method: 'POST',
        body: JSON.stringify({
        "code" : `${genius_code}`, "client_id" : "GtAcwB5MChoR-I0AVk71blFtVm-7G-MnNv3WOur_4T4sKZ-4FVlEDWzr7ShTzTny", "client_secret" : "C_3rJhRuvSV7Z4dUSmB4pJa1fJNKwMOD8sYWVyUf3jzwqGo19zLLaCtcroWxlXZTtvepIVGhugZUBVChSuendw", "redirect_uri" : "https://gusohnesorge.github.io/mashup_project/mashup.html", "response_type" : "code", "grant_type": "authorization_code"})
      };
